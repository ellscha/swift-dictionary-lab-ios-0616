...
if let anotherCapital = anotherCapital {
    print("Pennsylvania's capital is \(anotherCapital)")
} else {
    print("I don't know Pennsylvania's capital")
}
 ...
 */
// write your code here
let indexToDelete = statesAndCapitals.indexForKey("Pennsylvania")

statesAndCapitals.removeAtIndex(indexToDelete!)
...
let state = "New York"
// write your code here
let constantCapital = statesAndCapitals[state]!
 ...
 */
// write your code here
var bandByMember : [String : [String]] = ["Nirvana": ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
    "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
    "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
    "Pixies": ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
...
let bandName = "Pixies"
// write your code here
let pixieMembers = bandByMember[bandName]
